...
if __name__ == "__main__":
    ...
    # Convert to NumPy arrays and normalize pixels to [0, 1]
    ...
    # Official MNIST Split (First 60k for training, last 10k for testing)
    print("Applying official 60k/10k dataset split...")
    X_train = X[:60000]
